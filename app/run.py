...
app.config['PICKLE_FOLDER']= os.environ.get('PICKLE_FOLDER','C:/Users/Alex/Desktop/clasificacion_cerveza')
#settings
...
def consultaTrainer():
    ...
    data = cur.fetchall()
    print(data)
    return render_template('/entrenamiento.html', entrenamiento = data)
